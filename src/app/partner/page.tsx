...
const STEPS: Step[] = [
  {
    key: 'agentName',
    question:
      "Welcome! I'm Vira, and I'll help you list a property on our platform. Let's get started.\n\nFirst, what's your full name?",
  },
  {
    key: 'agency',
    question: "Great to meet you, {agentName}! Which agency or brokerage are you associated with?",
  },
  {
    key: 'contactEmail',
  ...
  {
    key: 'projectName',
    question: "Now let's talk about the property. What's the project or property name?",
  },
  {
    key: 'developerName',
    question: "Who is the developer or builder for this project?",
  },
  {
    key: 'location',
    question: "Where is the property located? Please share the full address or area + city.",
  },
  {
    key: 'propertyType',
    question: "What type of property is this?",
    widget: 'options',
    options: ['Apartment', 'Villa', 'Row House', 'Penthouse', 'Plot', 'Commercial'],
  },
  {
    key: 'configurations',
    question: "What configurations are available? You can select multiple.",
    widget: 'options',
    options: ['1 BHK', '2 BHK', '2.5 BHK', '3 BHK', '3.5 BHK', '4 BHK', '4+ BHK', 'Studio', 'Duplex'],
    multi: true,
  },
  {
    key: 'priceMin',
    question: "What's the starting price for this property? (e.g. 45 Lakhs, 1.2 Cr)",
  },
  {
    key: 'priceMax',
    question: "And the maximum price in the range?",
  },
  {
    key: 'photos',
    question: "Please upload some photos of the property. You can add multiple images.",
    widget: 'file-upload',
  },
  {
    key: 'usps',
    question:
      "What are the key highlights or USPs of this property? (Enter them one at a time, or comma-separated)",
  },
  {
    key: 'reraNumber',
    question: "What is the RERA registration number for this property?",
  },
  {
    key: 'websiteLink',
    question: "Finally, is there a website link for this project? (Type 'skip' if none)",
  },
]
...
export default function PartnerPage() {
  ...
  function interpolate(text: string, source: Record<string, unknown> = data as unknown as Record<string, unknown>): string {
  ...
  function advance(value: string | string[]) {
    ...
    if (next < TOTAL_STEPS) {
      ...
      // need to interpolate with the value we just set
      ...
      pushViraMessage(
        "Here's a summary of the property listing you've provided. Please review it and click **Submit for Review** when you're ready.",
        undefined,
        undefined,
        summary
      )
  ...
  function handleSubmit(e?: React.FormEvent) {
    ...
    // special handling for usps (comma separated)
    if (step.key === 'usps') {
      const items = trimmed
        .split(',')
        .map((s) => s.trim())
  ...
  function stepIcon(idx: number) {
    const icons = [
      User, Building2, Phone, Phone,
      Home, Building2, MapPin, Home,
      Home, IndianRupee, IndianRupee, Image,
      Star, Shield, Globe,
    ]
    ...
    <div className="flex flex-col h-[100dvh] bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200 px-4 py-3 flex items-center gap-3">
        ...
        <div className="flex items-center gap-2 flex-1">
          <ViraAvatar />
          <div>
            <h2 className="font-semibold text-gray-900 text-sm">Vira - Partner Onboarding</h2>
                ...
                <div className="ml-10 mb-4">
                  <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden max-w-lg">
                    <div className="bg-vira-600 px-4 py-3">
                      <h3 className="text-white font-semibold text-sm">Listing Summary</h3>
                    </div>
                  ...
                  <div className="bg-white rounded-xl border border-green-200 shadow-sm overflow-hidden max-w-md">
                    <div className="bg-green-50 p-6 flex flex-col items-center text-center">
                      ...
                      <p className="text-sm text-green-700 leading-relaxed">
                        Your property listing is now pending admin approval. We'll notify you via email
                        once it's reviewed.
                      </p>
                    </div>
